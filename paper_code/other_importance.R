...
data_plot <- data_plot_mean %>%
  ...
  mutate(
    item = factor(
      ...
      labels = c("Gain", "Cover", "Frequency", "Observational SHAP", "Interventional SHAP")
    )
  )
...
ggsave(filename = "./data/WS/plot/other_importance.png", width = 7, height = 4.5, units = "in", dpi = 600)
